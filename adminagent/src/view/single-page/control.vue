...
export default {
  ...
  data() {
    return {
      model1: [],
      req1: [
        { key: "userId", label: "开始日期", type: "input", value: "" },
        { key: "endTime", label: "结束日期", type: "input", value: "" },
        {
          key: "timeType",
          type: "radio",
          value: "",
      ...
      columns: [
        ...
        // { title: "平台", key: "platformName", width: 100, align: "center" },
    ...
    handleAllSearch() {
      ...
      getReportList(Data).then((res) => {
        ...
        if (res.data.code == 200) {
          ...
          //   d.userBetsTotal = String(-Number(d.userBetsTotal));
          // });
